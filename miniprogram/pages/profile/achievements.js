...
const ACHIEVEMENT_CONFIG = [
  ...
  { key: 'wisdom_75', name: '贤明之主', desc: '圣明指数达到75以上', category: 'explore', rarity: 'rare',
    unlockCondition: '圣明指数累计或阶段性达到≥75', reward: '+150 穿越点' },
  { key: 'type_all', name: '兼容并包', desc: '批阅过五种类型的奏折', category: 'explore', rarity: 'epic',
    unlockCondition: '奏事折、密折、请安折、谢恩折、奇葩折各至少批阅一份', reward: '+200 穿越点' },
