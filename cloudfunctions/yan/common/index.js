...
const CARRIER_LIST = ["qinghong", "guiyan", "daocao", "jingwei"].map((k) => ({
  key: k,
  ...CARRIERS[k],
}));
...
const FIGURES_FALLBACK = [
  {
    ...
    dynasty: "xianqin",
    dynastyName: "春秋",
    tone: '温厚谆谆，自称"丘"或"吾"。常引《诗》《书》，语短意长。',
  },
  {
    figureId: "fig-simqian",
    name: "司马迁",
    title: "太史公",
    dynasty: "han",
    dynastyName: "西汉",
    tone: '严谨深沉，引史实作评，自称"仆"，好作"太史公曰"。',
  },
  {
    figureId: "fig-caocao",
    name: "曹操",
    ...
    dynasty: "han",
    dynastyName: "东汉末",
    tone: '深沉果决，权谋在胸，自称"孤"或"吾"。好引《短歌行》。',
  },
  {
    figureId: "fig-taoqian",
    name: "陶渊明",
    title: "五柳先生",
    dynasty: "weijin",
    dynastyName: "东晋",
    tone: '淡泊超然，自称"潜"或"吾"。爱菊好酒，语出自然。',
  },
  {
    figureId: "fig-libai",
    name: "李白",
    ...
    dynasty: "tang",
    dynastyName: "盛唐",
    tone: '豪放飘逸，好饮好酒，自称"某"或"吾"。开口成诗，必带酒、月、剑、山水。',
  },
  {
    ...
    dynasty: "tang",
    dynastyName: "中唐",
    tone: '平易浅切，关心民生，自称"乐天"。老妪能解，多用白描。',
  },
  {
  ...
  },
  {
    ...
    dynasty: "song",
    dynastyName: "北宋",
    tone: '旷达幽默，善谈美食与养生，自称"某"或"吾"。亦庄亦谐。',
  },
  {
  ...
  },
  {
    ...
    dynasty: "song",
    dynastyName: "南宋",
    tone: '豪迈悲壮，自称"某"或"稼轩"。念念北伐，笔带金戈。',
  },
  {
    figureId: "fig-guanhanqing",
    name: "关汉卿",
    title: "已斋叟",
    dynasty: "yuan",
    dynastyName: "元",
    tone: '豪放不羁，自称"汉卿"。通晓市井，笔下多悲欢。',
  },
  {
    ...
    dynasty: "ming",
    dynastyName: "明",
    tone: '沉稳开阔，见多识广，自称"本使"。善言远洋风物。',
  },
  {
    figureId: "fig-wangyangming",
    name: "王阳明",
    title: "文成公",
    dynasty: "ming",
    dynastyName: "明",
    tone: '睿智通达，自称"守仁"。倡知行合一，语多哲思。',
  },
  {
    figureId: "fig-nalan",
    name: "纳兰性德",
    ...
    dynasty: "qing",
    dynastyName: "清",
    tone: '深情绵邈，自称"成德"。词风清哀，语出肺腑。',
  },
  {
    figureId: "fig-caoxueqin",
    name: "曹雪芹",
    title: "芹溪",
    dynasty: "qing",
    dynastyName: "清",
    tone: '博雅多情，自称"雪芹"。阅尽繁华，笔落沧桑。',
  },
];
...
async function loadDbFigures() {
  ...
  try {
    ...
    _dbFigures = (r.data || [])
      .map((f) => {
        const rawFigureId = f.figureId || f.id || "";
        const dbId = f._id || f.id || "";
        const figureId = rawFigureId || (dbId ? "fig-" + dbId : "");
        const fb = FIGURES_FALLBACK.find(
          (hf) =>
            hf.figureId === figureId ||
            hf.figureId === rawFigureId ||
            (dbId && hf.figureId === "fig-" + dbId),
        );
        return {
          figureId,
          _dbId: dbId,
          name: f.name || f.figureName || (fb ? fb.name : ""),
          title: f.title || f.identity || f.figureTitle || (fb ? fb.title : ""),
          dynasty: f.dynasty || (fb ? fb.dynasty : ""),
          dynastyName:
            DYNASTY_NAME_MAP[f.dynasty] ||
            f.dynastyName ||
            (fb ? fb.dynastyName : "") ||
            f.dynasty ||
            "",
...
const FIGURE_GIFT_MAP = {
  'fig-kongzi': {
    exclusive: ['g-brush', 'g-paper', 'g-yuxi'],
    dynasty: ['g-bronze', 'g-yubi', 'g-yuhuang'],
  },
  'fig-simqian': {
    exclusive: ['g-scroll', 'g-rubbing', 'g-songmo'],
    dynasty: ['g-tongjing', 'g-sushayi'],
  },
  'fig-caocao': {
    exclusive: ['g-wine', 'g-bronze', 'g-tongjian'],
    dynasty: ['g-jade', 'g-tongjing'],
  },
  'fig-taoqian': {
    exclusive: ['g-snack', 'g-fan', 'g-incense'],
    dynasty: ['g-pottery', 'g-kuixue'],
  },
  'fig-libai': {
    exclusive: ['g-wine', 'g-coin', 'g-jinbuyao'],
    dynasty: ['g-pottery', 'g-jade', 'g-tongjinghaishou'],
  },
  'fig-baijuyi': {
    exclusive: ['g-tea', 'g-fan', 'g-tuhaozhan'],
    dynasty: ['g-paper', 'g-coin', 'g-wumahuci'],
  },
  'fig-wuzetian': {
    exclusive: ['g-seal', 'g-coin', 'g-jinlong'],
    dynasty: ['g-jade', 'g-pottery', 'g-jinwan'],
  },
  'fig-sushi': {
    exclusive: ['g-tea', 'g-brush', 'g-hanshiti'],
    dynasty: ['g-snack', 'g-paper', 'g-dingyao'],
  },
  'fig-liqingzhao': {
    exclusive: ['g-paper', 'g-rubbing', 'g-kesi'],
    dynasty: ['g-fan', 'g-tea', 'g-jianyao'],
  },
  'fig-xinqiji': {
    exclusive: ['g-jade', 'g-rubbing', 'g-tongjian'],
    dynasty: ['g-bronze', 'g-scroll', 'g-longquan'],
  },
  'fig-guanhanqing': {
    exclusive: ['g-snack', 'g-incense', 'g-tihong'],
    dynasty: ['g-pottery', 'g-wine', 'g-yuanqinghua'],
  },
  'fig-zhenghe': {
    exclusive: ['g-pottery', 'g-seal', 'g-yunjin'],
    dynasty: ['g-jade', 'g-mingqinghua', 'g-dehua'],
  },
  'fig-wangyangming': {
    exclusive: ['g-scroll', 'g-brush', 'g-zhukebitong'],
    dynasty: ['g-fan', 'g-calligraphy', 'g-sheyan'],
  },
  'fig-nalan': {
    exclusive: ['g-fan', 'g-paper', 'g-cixiuxiangnang'],
    dynasty: ['g-calligraphy', 'g-incense', 'g-feicui'],
  },
  'fig-caoxueqin': {
    exclusive: ['g-calligraphy', 'g-scroll', 'g-qinglongpao'],
    dynasty: ['g-seal', 'g-rubbing', 'g-biyanhu'],
  },
};
...
function dropGift(power, figureId, dynasty) {
  ...
  function addCandidate(id, relationWeight) {
    if (seenIds[id]) return; // 去重：同一文物只保留最高权重
    var gift = null;
    for (var i = 0; i < GIFT_POOL.length; i++) {
      if (GIFT_POOL[i].id === id) {
        gift = GIFT_POOL[i];
        break;
      }
    }
    ...
    if (baseWeight <= 0) return; // 信使运力不支持
    var rarityMult = RARITY_MULTIPLIER[gift.rarity] || 1;
    var w = baseWeight * rarityMult * relationWeight;
    if (w > 0) {
      candidatePool.push({ gift: gift, weight: w });
      seenIds[id] = true;
    }
  }

  // 1. 角色专属文物池（专属 ×2.0 + 朝代 ×1.0）
  if (figureId && FIGURE_GIFT_MAP[figureId]) {
    var figMap = FIGURE_GIFT_MAP[figureId];
    (figMap.exclusive || []).forEach(function (id) {
      addCandidate(id, GIFT_RELATION_WEIGHT.exclusive);
    });
    (figMap.dynasty || []).forEach(function (id) {
      addCandidate(id, GIFT_RELATION_WEIGHT.dynasty);
    });
  }

  // 2. 朝代兜底池（×1.0）
  if (!candidatePool.length && dynasty && DYNASTY_GIFT_MAP[dynasty]) {
    DYNASTY_GIFT_MAP[dynasty].forEach(function (id) {
      addCandidate(id, GIFT_RELATION_WEIGHT.dynasty);
    });
  }
  ...
  if (!candidatePool.length) {
    GIFT_POOL.forEach(function (gift) {
      addCandidate(gift.id, GIFT_RELATION_WEIGHT.global);
    });
  }
